...
parser.add_argument(
    ...
    default=None,
    type=int,
    help="Maximum number of tasks to use in the experiment. If None, uses all tasks.")
...
parser.add_argument(
    ...
    default=None,
    type=str,
    help="Override the type of the tasks in the domain."
)
...
parser.add_argument(
    ...
    default="python",
    type=str,
    choices=["python", "ocaml", "pypy"],
    help="Which solver to use for enumeration."
)
...
parser.add_argument(
    ...
    default="",
    type=str,
    help="Suffix to append to the experiment type."
)

parser.add_argument(
    "--no_lang", default=False, action="store_true", help="Start w/ no language descriptions of any task."
)

parser.add_argument(
    "--n_samples_python", default=None, type=int, help="Number of samples to generate in Python solver."
)

def main(args):

    # Register SIGUSR1 to dump stack traces on demand.
    # This is useful for debugging hangs.
    # To dump a stack trace, run `kill -SIGUSR1 <pid>`.
    ...
    for random_seed in args.random_seeds:
        config_base = build_config(
            ...
            custom_experiment_type=args.experiment_type + args.type_suffix,
            domain=args.domain,
            ...
            n_samples_python=args.n_samples_python,
        )
