...
class DrawingsLoader(TaskDataLoader):
    ...
    def load_tasks_for_domain(self, domain, type_override=None):

        if type_override is not None:
            raise NotImplementedError(
                "Type override not implemented for DrawingsLoader."
            )
    ...
    def load_tasks(self, type_override=None):
        ...
        for domain in TASK_DOMAINS:
            domain_tasks = self.load_tasks_for_domain(domain, type_override)
...
class DrawingsNutsBoltsLoader(DrawingsLoader):
    ...
    def load_tasks(self, type_override=None):
        return self.load_tasks_for_domain(self.domain_name, type_override)
