...
class LAPSDreamCoderRecognition:
    ...
    def infer_programs_for_tasks(
        ...
        # Skip if # training steps is 0.
        if experiment_state.metadata[RECOGNITION_TRAIN_STEPS] == 0:
            print(f"infer_programs_for_tasks: recognition_train_steps is 0. Skipping.")
            return
    ...
    def optimize_model_for_frontiers(
        ...
        # Skip training if recognition_train_steps is 0
        if recognition_train_steps == 0:
            print(f"optimize_model_for_frontiers: recognition_train_steps is 0. Skipping.")
            return
