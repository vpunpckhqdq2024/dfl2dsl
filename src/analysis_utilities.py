...
from src.models.model_loaders import AMORTIZED_SYNTHESIS, GRAMMAR, LLM_SOLVER, LLM_SOLVER_PYTHON
    ...
    def get_test_solver_run_every_n(self, domain, experiment_type, seed):
        ...
        test_solver_block = list(
            filter(
                ...
                in [GRAMMAR, AMORTIZED_SYNTHESIS, LLM_SOLVER, LLM_SOLVER_PYTHON]
